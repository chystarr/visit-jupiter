...
function Attractions() {
  ...
  const descriptions = ["Jupiter's Great Red Spot is an anticyclonic storm near the planet's equator. It's the largest such storm known to exist in the solar system, and it was first observed nearly 400 years ago.",
    "Jupiter also has other eye-catching storms, many of which can be found on the planet's north pole. NASA's Juno mission recorded information about many of them in 2022.",
    "If you're looking for a change of scenery during your trip, or perhaps just some solid ground to stand on that a gas giant like Jupiter doesn't offer, Europa is an excellent choice. It's one of Jupiter's several moons, and it has an icy surface."];
